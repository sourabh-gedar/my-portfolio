...
const greeting = {
  ...
  resumeLink:
    "https://drive.google.com/file/d/1P1khTlyTac68jD17mR-YlG58eSD4GSoh/view?usp=sharing",
  ...
  data: [
    {
      ...
      skills: [
        "⚡ Develop highly interactive user interfaces using backend API web applications",
        "⚡ Building responsive website front end using React and Vue js",
  ...
  degrees: [
    {
      ...
      duration: "2021 - 2023",
      descriptions: [
        "⚡ I have taken varity of courses related to Software engineering , Database Management, Computer Vision etc.",
